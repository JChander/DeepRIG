...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('-o','--outputDir', type = str, default = 'hESC500',
...
dir_name = os.path.basename(os.path.dirname(os.path.normpath(expr_file)))
...
expr_df.to_csv(output_dir+'/' + dir_name + '-ExpressionData.csv')
...
if opts.netFile != 'None':
    ...
    netDF.to_csv(output_dir+'/'+ dir_name + '-network.csv', index=False)
